...
public class UpdateWorkspaceResponse {
    ...
    public UpdateWorkspaceResponse withInvalidInputExceptionInfo(WayScript.airbyte_test.models.shared.InvalidInputExceptionInfo invalidInputExceptionInfo) {
    ...
    public UpdateWorkspaceResponse withNotFoundKnownExceptionInfo(WayScript.airbyte_test.models.shared.NotFoundKnownExceptionInfo notFoundKnownExceptionInfo) {
    ...
    public UpdateWorkspaceResponse withWorkspaceRead(WayScript.airbyte_test.models.shared.WorkspaceRead workspaceRead) {
