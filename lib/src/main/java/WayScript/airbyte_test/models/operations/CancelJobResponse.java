...
public class CancelJobResponse {
    ...
    public CancelJobResponse withInvalidInputExceptionInfo(WayScript.airbyte_test.models.shared.InvalidInputExceptionInfo invalidInputExceptionInfo) {
    ...
    public CancelJobResponse withJobInfoRead(WayScript.airbyte_test.models.shared.JobInfoRead jobInfoRead) {
    ...
    public CancelJobResponse withNotFoundKnownExceptionInfo(WayScript.airbyte_test.models.shared.NotFoundKnownExceptionInfo notFoundKnownExceptionInfo) {
