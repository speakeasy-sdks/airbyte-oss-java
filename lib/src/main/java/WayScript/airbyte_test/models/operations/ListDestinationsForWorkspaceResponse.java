...
public class ListDestinationsForWorkspaceResponse {
    ...
    public ListDestinationsForWorkspaceResponse withDestinationReadList(WayScript.airbyte_test.models.shared.DestinationReadList destinationReadList) {
    ...
    public ListDestinationsForWorkspaceResponse withInvalidInputExceptionInfo(WayScript.airbyte_test.models.shared.InvalidInputExceptionInfo invalidInputExceptionInfo) {
    ...
    public ListDestinationsForWorkspaceResponse withNotFoundKnownExceptionInfo(WayScript.airbyte_test.models.shared.NotFoundKnownExceptionInfo notFoundKnownExceptionInfo) {
