...
public class ListJobsForResponse {
    ...
    public ListJobsForResponse withInvalidInputExceptionInfo(WayScript.airbyte_test.models.shared.InvalidInputExceptionInfo invalidInputExceptionInfo) {
    ...
    public WayScript.airbyte_test.models.shared.JobReadList jobReadList;

    public ListJobsForResponse withJobReadList(WayScript.airbyte_test.models.shared.JobReadList jobReadList) {
    ...
    public ListJobsForResponse withNotFoundKnownExceptionInfo(WayScript.airbyte_test.models.shared.NotFoundKnownExceptionInfo notFoundKnownExceptionInfo) {
